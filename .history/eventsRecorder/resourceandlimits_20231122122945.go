...
func serveWs(w http.ResponseWriter, r *http.Request, clientset *kubernetes.Clientset) {
	...
	for event := range watchInterface.ResultChan() {
		...
		fmt.Println("Resource Quota/Limit Range event received:", string(jsonEvent))
...
func main() {
	...
	fmt.Println("WebSocket server for Resource Quota and Limit Range events started on :8080")
